...
With a team of two (me and FE), we built on top of [*shadcn*](https://ui.shadcn.com/) and tailored it to our product needs — helping us move faster. In about a month, we documented foundational tokens and built 14 production-ready core React components.
