...
<Table
  columns={['Phase', 'Chef focus', 'Jobs to Be Done']}
  rows={[
    ['Cooking setup', '"What do I need to start cooking?"', 'Start the grill'],
    ['Cooking cycle', '"When will this batch finish?"', 'Prepare the next batch'],
  ]}
/>
