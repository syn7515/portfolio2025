...
The layout was designed for quick scanning — users can immediately assess current states and spot what had been changed. Information panel on right provide guidance on parameters users are editing so that users can adjust without guesswork.
