...
export const SUP_BADGE_BASE_CLASS =
  'sup-badge inline-flex items-center justify-center rounded-full w-[13px] h-[13px] text-[10px] leading-none font-medium !text-white [font-feature-settings:normal] cursor-pointer select-none relative -top-[5px] ml-[2px] transition-[background-color,opacity] duration-300 ease-out hover:!opacity-100';
...
export const SUP_BADGE_HIGHLIGHTED_CLASS =
  'bg-orange-700 dark:bg-orange-400 dark:!text-zinc-900';
